export const BOOTAY_PLANTER = {
    name: "Bootay Planter",
    header1: "Personal Project / 2022",
    text: [
...
export const GLYNWOOD_FARMS = {
    name: "Glynwood Farms",
    header1: "Climate-Smart Restoration / Glynwood Center for Regional Food and Farming",
    header2: "Cold Spring, NY / 2023",
    text: [
...
export const PASTURE_GRASSES = {
    name: "Pasture Grasses Booklet",
    header1: "Pasture Grasses Booklet / Glynwood Farms",
    header2: "Cold Spring, NY / 2023",
    text: [
...
export const MULTIFLORA = {
    name: "Multiflora Rose Ink Prints / Glynwood Farms",
    header1: "Cold Spring, NY / 2023",
    text: [
      "Multiflora Rose is a dense, thorny, invasive species in the American Northeast. To open an understanding relationship with the species, I pressed parts of the anatomy into ink even as the Glynwood farm crew and I thinned the population to allow for the addition of perennial foods and native forages to the farm.",
      "In the summer of 2023, I learned people performing restoration work are done with absolutist eradication. We can assist the environment through stewardship, but when we demonize the plants, we are overlooking the need they’re fulfilling in their environment created by own acts of colonization and deforestation.",
...
export const WEDDING = {
    name: "Wedding Signage / Programs, Invites, and Posters",
    header1: "Estes Park, CO / 2023",
    text: [
...
export const COLOR_PENCIL = {
    name: "Color Pencil",
    header1: "Personal Projects / 2023",
    text: [
...
export const PIZZA_PILLOW = {
    name: "Pizza Pillow",
    header1: "Hand baked and hand sewn / 2023",
    text: [
...
export const TATTOOS = {
    name: "Tattoos / For the friends",
    header1: "Pittsburgh to Chicago to New Zealand / 2023",
    text: [
...
export const ROCK_PEOPLE = {
    name: "Family Figures from Stone",
...
export const EARRINGS = {
    name: "Ginko Earrings / Laser and Hand-cut",
...
export const COUNCIL_DATA_PROJECT = {
    name: "Council Data Project / Graphic Design",
    header1: "Seattle, WA 2021",
    text: [
...
export const SACRAMENTO = {
    name: "Sacramento City Council Housing Research",
    header1: "Affordable Housing Research Associate / City Council",
    header2: "Sacramento, CA / 2018",
    text: [
...
export const PHOTOGRAPHY = {
    name: "General Photography / Independent and Hired",
    header1: "West to East Coast, US / 2024",
    text: [
      "",
    ],
    images: [
...
export const NATIVE_PLANT_PRINTS = {
    name: "Native Plant Ink Prints",
    header1: "Native Plant Radical Archive / Critic Abby Spinak",
...
export const CONCRETE_STOOL = {
    name: "The Slug Hug / Materials Study with Jonthan Grinham",
    header1: "Harvard GSD / 2021",
    header2: "Teammates John Adrian, Kai Blatt, Emily Eggers, Kaleb Swanson",
    text: [
      "The appearance of softness in the stool is achieved using a physically hard material. The interlocking design involves two hugging forms supporting each other, preventing one from standing alone. The stool is created through a double-molding process, using two fabric molds within a hard exterior mold, filled with two types of concrete—one plain and the other with added aggregate, repurposing sawdust waste. Various waste aggregates and discarded fabrics, such as gloves, leggings, denim, and plastic bags, were tested for reuse in a purposeful circular economy.",
